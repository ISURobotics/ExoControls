...
int sensorPin[] = { A1 }; // , A1 , A2 , A3 , A4 , A5 , A6 , A7 };
...
//  }
  ...
  //for (int i = 0; i < (sizeof(sensorPin) / sizeof(int)); i++) {
    ...
    //int output = (map(abs(moveVal), 0, 300, 150, 255));
    ...
    digitalWrite(digWArr[0], dir);
    analogWrite(anaWArr[0], 0);

    //if (moveVal != 0) {
      Serial.print("Actuator: ");
      Serial.print(anaWArr[0], DEC);
      Serial.print(" | Dir: ");
